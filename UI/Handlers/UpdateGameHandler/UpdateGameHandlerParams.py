class UpdateGameHandlerParams(object):
    def __init__(self):
        self.__id = ""
        self.__title = ""
        self.__num_copies = 0
    ...
    def __eq__(self, other):
        return (self.id == other.id and self.title == other.title and self.num_copies == other.num_copies and
                self.num_boxed == other.num_boxed and self.num_manuals == other.num_manuals and
                self.platform == other.platform and self.notes == other.notes)