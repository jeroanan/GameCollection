...
class AllGamesHandler(AuthenticatedHandler):
    ...
    def get_page(self, params):
        ...
        :param params: A dictionary containing the following keys:
                          ...
                          * platform
                          * user_id
        :returns: All games in a user's collection for the given platform. If platform is not set 
                     then all games in the user's collection are returned.
        """
        ...
        return self.renderer.render("allgames.html",
                                    games=games,
                                    title="All Games",
