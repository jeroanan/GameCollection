...
from Interactors.Exceptions.UnrecognisedInteractorTypeException \
...
class TestInteractorFactory(unittest.TestCase):
    ...
    def test_create(self):
        ...
        mappings = {"AddGameInteractor": game_interactors.AddGameInteractor,
                    ...
                    "CountHardwareTypesInteractor": 
                        hardware_interactors.CountHardwareTypesInteractor,
                    ...
                    "DeleteHardwareTypeInteractor": 
                        hardware_interactors.DeleteHardwareTypeInteractor,
                    ...
                    "GetHardwareDetailsInteractor": 
                        hardware_interactors.GetHardwareDetailsInteractor,
                    ...
                    "GetHardwareTypeListInteractor": 
                        hardware_interactors.GetHardwareTypeListInteractor,
                    ...
                    "GetSuggestedHardwareTypesInteractor": 
                        hardware_interactors.GetSuggestedHardwareTypesInteractor,
                    "GetSuggestedPlatformsInteractor":
                        platform_interactors.GetSuggestedPlatformsInteractor,
                    ...
                    "UpdateHardwareTypeInteractor":
                        hardware_interactors.UpdateHardwareTypeInteractor,
        ...
        def assert_mapping(m):
            self.assertIsInstance(
                self.__target.create(m), mappings[m], m)
