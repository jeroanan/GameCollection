...
class TestSaveHardwareInteractor(InteractorTestBase):
    ...
    def test_execute_with_null_hardware_raises_type_error(self):
        """Test that calling SaveHardwareInteractor.execute with a null hardware parameter causes 
    ...
    def test_execute_validates_integer_fields(self):
        """Test that calling SaveHardwareInteractor.execute causes the integer members of 
        Hardware to be validated"""
