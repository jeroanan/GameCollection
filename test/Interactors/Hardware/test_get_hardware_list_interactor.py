...
from Interactors.Hardware.Params.GetHardwareListInteractorParams import \
...
class TestGetHardwareListInteractor(InteractorTestBase):
    ...
    def test_execute_with_no_platform_calls_get_hardware_list_persistence_method(self):
        """Test that calling GetHardwareListInteractor.execute causes 
        persistence.get_hardware_list to be called"""
        p = self.__get_params()
        p.platform = ""
    ...
    def test_execute_with_platform_calls_get_hardware_list_for_platform_persistence_method(self):
        """Test that calling GetHardwareListInteractor.execute causes
        persistence.get_hardware_list_for_platform to be called"""
        p = self.__get_params()
        self.__target.execute(p)
