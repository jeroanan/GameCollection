...
class TestDeletePlatformHandler(unittest.TestCase):
    ...
    def test_deleltion_successful_returns_json_ok_message(self):
        """
        Test that when a platform is deleted successfully, a json object with a result field with
        a value of 'ok' is returned.
        """
    ...
    def test_bad_id_gives_json_validation_failed_message(self):
        """
        Test that setting params['id'] to different bad values causes
