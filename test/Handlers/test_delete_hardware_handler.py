"""Provides unit tests for the DeleteHardwareHandler class."""
...
class TestDeleteHardwareHandler(unittest.TestCase):
    ...
    def test_interactor_raises_exception_returns_empty_string(self):
        """Test that if DeleteHardwareInteractor.execute raises an exception then 
        DeleteHardwareHandler.get_page returns an empty string"""
