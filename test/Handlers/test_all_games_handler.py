"""Provides unit tests for the AllGamesHandler class"""
...
class TestAllGamesHandler(unittest.TestCase):
    """Unit tests for the AllGamesHandler class"""
    ...
    def test_get_page_calls_renderer(self):
        """Test that calling AllGamesHandler.get_page causes GetGamesInteractor.execute to be
        called"""
        self.__get_page()
