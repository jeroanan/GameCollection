"""Provides unit tests for the AddGenreHandler class"""
...
class TestAddGenreHandler(unittest.TestCase):
    ...
    def test_misssing_required_params_returns_empty_string(self):
        """Missing required parameters to AddGenreHandler.get_page should cause it to return an 
        empty string"""
        params = ["name", "description"]
        self.assertRaises(
            ValueError,
            lambda: assert_operation_on_params_returns_true(self.__missing_param_test, params))

    def test_empty_required_params_returns_empty_string(self):
        """Empty required parameters to AddGenreHandler.get_page should cause it to return an
        empty string"""
        params = ["name", "description"]
        self.assertRaises(
            ValueError,
            lambda: assert_operation_on_params_returns_true(self.__empty_param_test, params))
