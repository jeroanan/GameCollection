"""Provides unit tests for the HardwareTypesHandler class"""
...
class TestHardwareTypesHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        def create_interactor(interactor_type):
            ...
            interactors = {
                "GetHardwareTypeListInteractor": (hi.GetHardwareTypeListInteractor, 
                                                  self.__stored_hardware_types),
                "GetSuggestedHardwareTypesInteractor": (hi.GetSuggestedHardwareTypesInteractor, 
                                                        self.__suggested_hardware_types)
            }
    ...
    def test_get_page_calls_renderer_correctly(self):
        """Test that calling HardwareTypesHandler.get_page causes TemplateRenderer.render to be 
        called correctly"""
