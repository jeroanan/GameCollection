"""Provides unit tests for the GenresHandler class"""
...
class TestGenresHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        def interactor_factory_create(interactor_type):
            ...
            if interactor_type == "GetSuggestedGenresInteractor":
    ...
    def test_get_page_renders_page(self):
        """Test that calling GenresHandler.get_page causes renderer.render to be called with the 
        correct parameters"""
