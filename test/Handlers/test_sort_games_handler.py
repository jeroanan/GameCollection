"""Provides unit tests for the SortGamesHandler class"""
...
class TestSortGamesHandler(unittest.TestCase):
    ...
    def test_get_page_calls_renderer(self):
        """Test that calling SortGamesHandler.get_page causes renderer.render to be called 
        correctly"""
        ...
        self.__renderer.render.assert_called_with(
            "games.html",
            games=self.__games,
            game_sort_field=args["field"],
            game_sort_dir=args["sortdir"])
