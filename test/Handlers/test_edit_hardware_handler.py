"""Provides unit tests for the EditHardwareHandler class"""
...
class TestEditHardwareHandler(unittest.TestCase):
    ...
    def setUp(self):
        ...
        def interactor_factory_create(interactor_type):
            ...
            interactors = {"GetHardwareDetailsInteractor":
                                (hi.GetHardwareDetailsInteractor, self.__hardware),
                           "GetPlatformsInteractor": (pi.GetPlatformsInteractor, self.__platforms),
                           "GetHardwareTypeListInteractor":
                                (hi.GetHardwareTypeListInteractor, self.__hardware_types)}
    ...
    def test_calls_renderer(self):
        """Test that calling EditHardwareHandler.get_page causes renderer.render to be called 
        correctly"""
        self.__get_page()
