"""Provides unit tests for the GetExportHandler class"""
...
class TestGetExportHandler(unittest.TestCase):
    """Unit tests for the GetExportHandler class"""
    ...
    def test_is_instance_of_interactor(self):
        """Test that GetExportHandler is derived from AuthenticatedHandler"""
        self.assertIsInstance(self.__target, ah.AuthenticatedHandler)

    def test_get_page(self):
        """Test that calling GetExportHandler.get_page causes the interactor to be executed"""
        self.__target.get_page({ 'data[]': ['spam', 'eggs']})

    def test_get_page_executes_collection_interactor(self):
        """Test that calling GetExportHandler.get_page causes the interactor to be executed with
