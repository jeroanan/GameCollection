"""Provides unit tests for the SaveGameHandler class"""
...
class TestSaveGameHandler(unittest.TestCase):
    ...
    def test_get_page_executes_interactor(self):
        """Test that calling SaveGameHandler.get_page causes AddGameInteractor.execute to be 
        called"""
        self.__get_page()
    ...
    def test_empty_required_params_returns_empty_string(self):
        """Test that calling SaveGameHandler with an empty required parameter causes an empty 
    ...
    def test_missing_required_params_returns_empty_string(self):
        """Test that calling SaveGameHandler with a missing required parameter causes an empty 
        string to be returned"""
        p = self.__get_args()
        for r in self.__required_params:
