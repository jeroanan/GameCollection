"""Provides unit tests for the UpdateHardwareHandler class"""
...
class TestUpdateHardwareHandler(unittest.TestCase):
    ...
    def test_executes_interactor(self):
        """Test that calling UpdateHardwareHandler.get_page causes
        UpdateHardwareInteractor.execute to be called"""
    ...
    def test_empty_required_param_returns_empty_string(self):
        """Test that calling UpdateHardwareHandler.get_page with an empty required parameter 
    ...
    def test_null_required_param_returns_empty_string(self):
        """Test that calling UpdateHardwareHandler.get_page with a missing required parameter 
        returns an empty string"""
