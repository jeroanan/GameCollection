"""Provides unit tests for the UpdateHardwareTypeHandler class"""
...
class TestUpdateHardwareTypeHandler(unittest.TestCase):
    ...
    def test_successful_save_returns_json_ok_message(self):
        """
        Test that successfully updating a hardware type returns a json object with a field called 
        'result' whose value is 'ok'.
        """
    ...
    def test_none_hardware_type_returns_json_validation_failed_message(self):
        """
        Test that when hardware_type is None then a json object is returned with a field called 
        'result' whose value is 'validation_faled'
        """
        assertion = hta.get_params_returns_json_result_value_assertion(self, self.__target)
    ...
    def test_required_param_forbidden_value_returns_json_validation_failed_message(self):
        """
        Test that if a required parameter has a forbidden value then a json object is returned 
        with a field called 'result' whose value is 'validation_failed'
        """
