"""Provides unit tests for the SaveHardwareHandler class"""
...
class TestSaveHardwareHandler(unittest.TestCase):
    ...
    def test_get_page_executes_save_hardware_interactor(self):
        """Test that calling SaveHardwareHandler.execute causes SaveHardwareInteractor.execute to 
        be called"""
    ...
    def test_null_required_param_returns_empty_string(self):
        """Test that calling SaveHardwareHandler.get_page with a null required parameter causes 
    ...
    def test_empty_required_param_returns_empty_string(self):
        """Test that calling SaveHardwareHandler.get_page with an empty required parameter causes 
        an empty string to be returned"""
