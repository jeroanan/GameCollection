...
class MongoPersistence(AbstractPersistence):
    ...
    def __map_games_list(self, result_set):
        return list(map(Game.from_mongo_result, result_set))
    ...
    def get_platforms(self):
        ...
        platforms = list(map(Platform.from_mongo_result, result))
        return platforms
    ...
    def get_hardware_types_list(self):
        ...
        """
        return list(map(
            ht.HardwareType.from_mongo_result,
    ...
    def get_hardware_list_for_platform(self, params):
        ...
        return list(map(Hardware.from_mongo_result, hardware))
